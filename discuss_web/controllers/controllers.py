...
class MailChatController(BusController):
    ...
    # --------------------------
    @route('/discuss/chat_post', type="json", auth="none")
    ...
    @route(['/discuss/chat_history'], type="json", auth="none")
...
class MailController(http.Controller):
    ...
    @route('/discuss/receive', type='json', auth='none')
    ...
    @route('/discuss/read_followers', type='json', auth='user')
    ...
    @route('/discuss/read_subscription_data', type='json', auth='user')
    ...
    @route('/discuss/view', type='http', auth='none')
    ...
    @route('/discuss/follow', type='http', auth='user', methods=['GET'])
    ...
    @route('/discuss/unfollow', type='http', auth='user', methods=['GET'])
    ...
    @route('/discuss/new', type='http', auth='user')
    ...
    @route('/discuss/assign', type='http', auth='user', methods=['GET'])
    ...
    @route('/discuss/<string:res_model>/<int:res_id>/avatar/<int:partner_id>', type='http', auth='public')
    ...
    @route('/discuss/needaction', type='json', auth='user')
    def needaction(self):
        return request.env['res.partner'].get_needaction_count()

    @route('/discuss/client_action', type='json', auth='user', website='true')
    ...
    @route('/discuss', type='http', auth='user', website='true')
    def discuss_index(self):
        ...
        return request.render("discuss_web.index", values)